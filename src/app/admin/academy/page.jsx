  ...
  const fetchAllBlogs = useCallback(async () => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_LOCAL_PORT}/api/blogs/academy`,
      );
        ...
        <div className="bg-white  shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="overflow-x-auto">
            {loading ? (
              ...
              <thead className="bg-[#153291] text-white">
                  <tr>
  ...
  {blogs.length === 0 ? (
    <tr>
      <td colSpan={7} className="px-6 py-12 text-center">
        ...
        <Link
          href="/admin/add"
          className="inline-flex items-center gap-2 bg-[#153291] text-white px-6 py-2 hover:bg-[#153291]/90 transition-colors duration-200"
        >
          <FaPlus />
    ...
    blogs.map((blog, idx) => (
      ...
      >
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <div className="font-medium text-gray-900 w-8 h-8 flex items-center justify-center">
            {idx + 1}.
          </div>
        </td>
        ...
        <td className="px-6 py-4">
          <div className="max-w-xs">
            <div className="text-sm font-semibold capitalize text-gray-900 group-hover:text-cc5f4d transition-colors duration-200 line-clamp-2">
              {blog.type}
            </div>
            {blog.tag && (
        ...
        {/* Service */}
        {/* <td className="px-6 py-4 whitespace-nowrap">
          <span className="inline-flex items-center px-3 py-1 text-sm font-medium bg-6db19b/10 text-6db19b capitalize">
            {blog.service || "—"}
          </span>
        </td> */}
