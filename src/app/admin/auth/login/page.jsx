...
const AdminLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_LOCAL_PORT}/api/admin/login`,
        {
          method: "POST",
          credentials: "include",
  ...
  const handleForgotPasswordEmail = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_LOCAL_PORT}/api/admin/sendotp`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
 ...
 setForgotPasswordLoading(true)
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_LOCAL_PORT}/api/admin/verifyotp`,{
          method: "POST",
